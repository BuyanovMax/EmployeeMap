...
public class DepartmentController {
    ...
    public EmployeeMap findMaxSalary(@RequestParam int department) {
        return this.departmentService.findMaxSalary(department);
    }
    @GetMapping(path = "/min-salary")
    public EmployeeMap findMinSalary(@RequestParam int department) {
        return this.departmentService.findMinSalary(department);
    }
    @GetMapping(value = "/all",params = "/departmentId")
    public List<EmployeeMap> findAllEmployeeByDepartment(@RequestParam int department) {
